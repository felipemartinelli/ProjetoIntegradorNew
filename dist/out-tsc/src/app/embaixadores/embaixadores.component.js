...
let EmbaixadoresComponent = class EmbaixadoresComponent {
...
EmbaixadoresComponent = tslib_1.__decorate([
    Component({
        selector: 'app-embaixadores',
        templateUrl: './embaixadores.component.html',
        styleUrls: ['./embaixadores.component.css'],
        providers: [Globals]
    })
], EmbaixadoresComponent);
export { EmbaixadoresComponent };
//# sourceMappingURL=embaixadores.component.js.map